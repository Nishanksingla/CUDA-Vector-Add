...
int main(void)
{
    ...
    err = cudaMalloc((void**)&d_A, size);   // FILL HERE
...
if (err != cudaSuccess)
    ...
    err =  cudaMalloc((void**)&d_B, size);      // FILL HERE
    ...
    err =  cudaMalloc((void**)&d_C, size);        // FILL HERE
    ...
    err = cudaMemcpy(h_C,d_C,size,cudaMemcpyDeviceToHost);  // FILL HERE
